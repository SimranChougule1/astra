...
import { getCustomizrSettings } from '../../../utils/customize';
...
export const responsiveFontSize = async ( fontSize ) => {
	...
	const bodyFontTablet = bodyFontSize.settings.tablet !== '' ? bodyFontSize.settings.tablet : bodyFontDesktop;
	const bodyFontMobile = bodyFontSize.settings.mobile !== '' ? bodyFontSize.settings.mobile : bodyFontTablet;
